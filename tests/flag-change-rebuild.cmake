...
fixture_build(out)
assert_build_ok(out)
assert_contains("${out}" "Compiling Hylo module Base (" "global flag change must recompile Base")
assert_contains("${out}" "Compiling Hylo module MainDiamond (" "global flag change must recompile App")
...
assert_build_ok(out)
assert_contains("${out}" "Compiling Hylo module Left (" "per-target option change must recompile Left")
assert_not_contains("${out}" "Compiling Hylo module Base (" "unrelated module must not recompile")
assert_exit("${WORK_DIR}/build/diamond/diamond" 23)
