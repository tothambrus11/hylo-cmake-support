...
assert_not_contains("${out}" "Compiling Hylo module" "C edit must not recompile the Hylo module")

file(TOUCH_NOCREATE "${WORK_DIR}/src/c-interop/LibC.hylo")
fixture_build(out)
assert_build_ok(out)
assert_contains("${out}" "Compiling Hylo module MainCInterop (" "touched Hylo source must recompile the module")
